    ...
    public partial class Level2 : Form
    {
        ...
        private void Level2_Load(object sender, EventArgs e)
        {
            ...
            while (sayac < 3)
            {
                ...
                sayilar = sayi_a2.Next(5, 15);
                Random sayi_a2_2 = new Random();
                sayilar2 = sayi_a2_2.Next(5, 15);
            ...
            {
                Random sayi_a2 = new Random();
                sayilar_a2 = sayi_a2.Next(5, 15);
                Random sayi_a2_2 = new Random();
                sayilar_a2_2 = sayi_a2_2.Next(5, 15);
            ...
            while (sayac_a3 < 3)
            {
                ...
                sayilar_a3 = sayi_a3.Next(5, 15);
                Random sayi_a3_2 = new Random();
                sayilar_a3_2 = sayi_a3_2.Next(5, 15);
        ...
        private void animasyon_Tick(object sender, EventArgs e)
        {
            ...
            if (saniye == 25 && nilufer1 == true)
            {
                ...
                double sayi = Convert.ToInt32(label7.Text);
            ...
            if (saniye == 25 && nilufer2 == true)
            {
                ...
                double sayi = Convert.ToInt32(label1.Text);
                int index = listBox2.FindString(sayi.ToString());
                if (index == -1)
                {
