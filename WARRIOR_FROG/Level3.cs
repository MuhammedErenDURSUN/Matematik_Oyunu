    ...
    public partial class Level3 : Form
    {
        ...
        private void animasyon_Tick(object sender, EventArgs e)
        {
            ...
            if (saniye == 170 && nilufer14 == true)
            {
               ...
               MessageBox.Show("BİR SONRAKİ BÖLÜME GEÇMEK İÇİN TIKLAYINIZ...", "TEBRİKLER BÖLÜMÜ BAŞARILI BİR ŞEKİLDE GEÇTİNİZ...", MessageBoxButtons.OK, MessageBoxIcon.Information);
